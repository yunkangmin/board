//파일 업로드용  클래스.
//파일 업로드 시 고려해야 할 사항
//1. 자동적인 폴더의 생성이 가능해야 한다.(폴더 저장 용량의 한계로 년/월/일 식의 폴더 생성이 가능해야한다.)
//2. 파일 저장은 UUID를 이용해서 이름이 중복되는 것을 막는다.
//3. 이미지가 업로드됬을 때 썸네일 이미지를 생성하여 브라우저에 보여줌으로서 서버의 부하를 줄인다.
package org.tams.util;
...
//  
  ...
  //년/월/일로 된 문자열 경로를 생성하고 그 문자열 경로를 리턴한다.
  ...
  private static void makeDir(String uploadPath, String... paths){
	...
	//경로에 대한 파일이 이미 존재한다면 종료. 
	//paths[paths.length-1]는 dataPath를 의미.
	// 예) \2020\07\17  
